//
//  ResponderExampleListViewController.m
//  iOSProject
//
...
@interface ResponderExampleListViewController ()<YLTableViewDelete>
@property (nonatomic, strong) YLTableView  * tableView;
@property (nonatomic, assign) NSInteger page;
@property (nonatomic, strong) NSMutableArray * dataArray;
@end

@implementation ResponderExampleListViewController
...
-(void)initialDataSource {
    ...
    model.desc = [NSString stringWithFormat:@"不规则图形中的应用"];
...
-(void)didselectedCell:(NSInteger)index {
    ...
    NSLog(@"%@",@(index));
    if (index == 0) {
        ReponderTestViewController * vc = [ReponderTestViewController new];
