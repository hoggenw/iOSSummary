...
/*
 网络切换的时候需要显示的提示界面
 */
@property(nonatomic,strong)YLNetNotiView *netShowView;

/*
 播放器加载界面
 */
@property(nonatomic,strong)YLLoadingView *loadingView;
/*
 锁定按钮
 */
@property(nonatomic,strong)YLMediaButton *btnLock;

/*
 返回按钮
 */
@property(nonatomic,strong)YLMediaButton *backBtn;

/*
 播放器播放/暂停按钮
 */
@property(nonatomic,strong)YLMediaButton *playBtn;
/*
 全屏按钮
 */
@property(nonatomic,strong)YLMediaButton *fullScreenBtn;
/*
 显示播放器当前时间的label
 */
...
/*
 播放器的一些相关参数
 */
@property(nonatomic,strong)YLPlayerOption *playerOption;
...
/*
 初始化视频播放器
 */
-(instancetype)initWithFrame:(CGRect)frame delegate:(id)delegate url:(NSString *)url placeHolderImg:(NSString * __nullable)placeHolderImgName playerOption:(YLPlayerOption * __nullable)playerOption;
