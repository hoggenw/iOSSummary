...
-(void)layoutSubviews
{
    ...
    if (self.netWorkNotiViewType == YLNetNotiViewTypeOfNoNetWork) {
        [self contentWithNoNetWork];
    }else if (self.netWorkNotiViewType == YLNetNotiViewTypeOfBecomeWWAN)
    {
...
{
    self.netWorkNotiViewType = YLNetNotiViewTypeOfNoNetWork;
...
{
    self.netWorkNotiViewType = YLNetNotiViewTypeOfBecomeWWAN;
...
-(void)showNetNotiViewWithType:(YLNetNotiViewType)type
{
    ...
    switch (type) {
        case YLNetNotiViewTypeOfNoNetWork :
            [self contentWithNoNetWork];
            break;
        case YLNetNotiViewTypeOfBecomeWWAN:
            [self contentWithWWAN];
            break;
        default:
            break;
