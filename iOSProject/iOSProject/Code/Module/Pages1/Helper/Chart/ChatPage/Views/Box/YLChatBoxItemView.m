...
@interface YLChatBoxItemView()
@property (nonatomic, strong) UIButton *button;
@property (nonatomic, strong) UILabel *titleLabel;
@end

@implementation YLChatBoxItemView

+ (YLChatBoxItemView *) createChatBoxMoreItemWithTitle:(NSString *)title imageName:(NSString *)imageName{
    
    YLChatBoxItemView *item = [[YLChatBoxItemView alloc] init];
    item.title = title;
