...
//    [self.tableView registerClass: [HouseTableViewCell class] forCellReuseIdentifier:@"HouseTableViewCell"];
//    [self.tableView registerNib:[UINib nibWithNibName:@"VoteTableViewCell" bundle:nil] forCellReuseIdentifier:@"VoteTableViewCell"];
//    [self.tableView registerNib:[UINib nibWithNibName:@"CionChioceTableViewCell" bundle:nil] forCellReuseIdentifier:@"CionChioceTableViewCell"];//
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_cellType == Default) {
        // cell重用机制
        DefaultTableViewCell * cell = [DefaultTableViewCell cellInTableView:tableView];
        // cell数据展示
        DefualtCellModel *model = [self.dataArray objectAtIndex:indexPath.row];
        cell.model = model;
        return cell;
    }
