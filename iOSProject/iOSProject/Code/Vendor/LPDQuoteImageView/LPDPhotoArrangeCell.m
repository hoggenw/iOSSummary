...
- (instancetype)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]){
        ...
        _showLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.lpd_width, self.lpd_height)];
        _showLabel.backgroundColor = [UIColor colorWithWhite:1 alpha:0.5];
        _showLabel.contentMode = UIViewContentModeScaleToFill;
        _showLabel.layer.cornerRadius = 4;
        _showLabel.layer.borderColor = [[UIColor groupTableViewBackgroundColor] CGColor];
        _showLabel.layer.borderWidth = 2;
        _showLabel.clipsToBounds = YES;
        _showLabel.userInteractionEnabled = true;
